...
<br>
<br>
A class of methods which mitigate both problems, i.e., which reduce the (peak) intensity -- to achieve a certain spatial STED microscopy resolution, and the system complexity, base on the analysis of the fluorescence dynamics.   
